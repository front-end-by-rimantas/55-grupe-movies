...
adminPageRouter.get('/categories/:urlSlug', async (req, res) => res.send(await new PageAdminCategoriesNew(req).render()));
adminPageRouter.get('/categories/:urlSlug/edit', async (req, res) => res.send(await new PageAdminCategoriesNew(req).render()));
